    ...
    <main>
      <section id="centro">
        ...
        <div id="contenido">
          ...
          {/* Imagen principal de la pastelería */}
          ...
          <div className="cta-buttons">
            <Link to="/catalogo" className="btn-cta">Ver Catálogo</Link>
            <a href="#destacados" className="btn-cta">Productos Destacados</a>
          </div>
        </div>

        {/* Sección de Historia y Logros */}
        ...
        <div id="destacados">
          <h2 className="seccion-titulo">Nuestros Productos Destacados</h2>
          
          <div id="catalogo">
            <div className="card">
              <img src="https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=300&h=250&fit=crop&crop=entropy&auto=format" alt="Tortas Circulares" />
              <Link to="/tortascircular">Tortas Circulares</Link>
            </div>
            
            <div className="card">
              <img src="https://images.unsplash.com/photo-1557979619-445218f326b9?w=300&h=250&fit=crop&crop=entropy&auto=format" alt="Pasteles Individuales" />
              <a href="#pasteles">Pasteles Individuales</a>
            </div>
            
            <div className="card">
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRkBLoBHe7bjkgt9w1vr1mWuCte8n9qp2Pm_Q&s" alt="Cupcakes" />
              <a href="#cupcakes">Cupcakes</a>
            </div>
            
            <div className="card">
              <img src="https://easyways.cl/storage/20201209100310panna-cotta-de-vainilla.jpg" alt="Repostería Especial" />
              <a href="#especial">Repostería Especial</a>
            </div>
          </div>
        </div>
        ...
        <div id="cta-final">
          ...
          <Link to="/catalogo" className="btn-final">Explorar Catálogo</Link>
        </div>
      </section>
    </main>
  );
